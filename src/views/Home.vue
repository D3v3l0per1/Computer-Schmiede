  ...
  export default {
    ...
    data () {
      return {
        service_items: [
          { 
            icon: 'https://firebasestorage.googleapis.com/v0/b/computerschmiede-jenbach.appspot.com/o/icons%2Fberatung.jpg?alt=media&token=741071d3-6c7b-438c-933e-2cbe9f292fdb', 
            title: 'Beratung', 
